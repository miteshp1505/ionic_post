...
/**
 * Generated class for the DainiknewsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-dainiknews',
  templateUrl: 'dainiknews.html',
})
export class DainiknewsPage {
...
@ViewChild('SwipedTabsSlider') SwipedTabsSlider: Slides ;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad DainiknewsPage');
	...
	this.rssProvider.getDainikInternational().subscribe(data => {
	 ...
	 this.rssProvider.getDainikNational().subscribe(data => {
	 ...
	 this.rssProvider.getDainikSports().subscribe(data => {
	...
	this.rssProvider.getDainikEducation().subscribe(data => {
...
openLink(link){
  ...
  labelClick(){
	this.authService.postData(this.headerData, "getDBHeaderLink").then((result) =>{
