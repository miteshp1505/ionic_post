...
/**
 * Generated class for the JagrannewsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-jagrannews',
  templateUrl: 'jagrannews.html',
})
export class JagrannewsPage {
 @ViewChild('SwipedTabsSlider') SwipedTabsSlider: Slides ;
  ...
  public loadingCtrl: LoadingController, public navParams: NavParams ,public rssProvider: RssProvider) {
	  this.tabs=["English Releases","Hindi Releases","English Features"];
	 // this.selectTab(0);
  }
  ...
  ionViewDidLoad() {
	...
	this.rssProvider.getjagranInternationalFeed().subscribe(data => {
	...
	this.rssProvider.getjagranNationalFeed().subscribe(data => {
	...
	this.rssProvider.getjagranSportsFeed().subscribe(data => {
	...
	/*this.rssProvider.getjagranEducationFeed().subscribe(data => {
  ...
  labelClick(){
	this.authService.postData(this.headerData, "getPIBHeaderLink").then((result) =>{
