...
/**
 * Generated class for the IndianexpressnewsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-indianexpressnews',
  templateUrl: 'indianexpressnews.html',
})
export class IndianexpressnewsPage {
@ViewChild('SwipedTabsSlider') SwipedTabsSlider: Slides ;
  ...
  ionViewDidLoad() {
	...
	this.rssProvider.getIndianExpressInternational().subscribe(data => {
	...
	this.rssProvider.getIndianExpressNational().subscribe(data => {
	...
	this.rssProvider.getIndianExpressSports().subscribe(data => {
	...
	this.rssProvider.getIndianExpressEducation().subscribe(data => {
  ...
  labelClick(){
	this.authService.postData(this.headerData, "getLHNHeaderLink").then((result) =>{
