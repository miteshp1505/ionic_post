...
/**
 * Generated class for the FeaturedquizPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-featuredquiz',
  templateUrl: 'featuredquiz.html',
})
export class FeaturedquizPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad FeaturedquizPage');
	
	
		this.authService.postData(this.userPostData, "getFeaturedExamQuiz").then((result) =>{
